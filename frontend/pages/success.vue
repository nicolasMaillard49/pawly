...
useSeoMeta({
  title: `Commande Confirmée - ${storeConfig.storeName}`,
  robots: 'noindex',
})
      ...
      <div v-else class="text-center">
        ...
        <div v-if="order" class="bg-surface-light border border-surface-lighter rounded-2xl p-6 sm:p-8 text-left mb-10">
          ...
          <div class="space-y-4">
            <div v-if="order.orderNumber" class="flex justify-between items-center">
              ...
              >
                {{ storeConfig.orderPrefix }}-{{ String(order.orderNumber).padStart(5, '0') }}
              </NuxtLink>
            </div>
        ...
        <div v-if="order?.orderNumber" class="mb-8">
          ...
          >
            ...
            Suivre ma commande {{ storeConfig.orderPrefix }}-{{ String(order.orderNumber).padStart(5, '0') }}
          </NuxtLink>
        </div>
